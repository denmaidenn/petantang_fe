...
export default function Labvokshome() {
  ...
  const steps = [
    {
      title: "Scan KTM Digital",
      desc: "Pindai QR Code KTM Digital Anda.",
      icon: <QrCode className="w-5 h-5" />,
    },
    {
      title: "Verifikasi Wajah",
      desc: "Validasi identitas melalui biometrik wajah.",
      icon: <ScanFace className="w-5 h-5" />,
    },
    {
      title: "Syarat & Ketentuan",
      desc: "Persetujuan pakta integritas penggunaan lab.",
      icon: <FileText className="w-5 h-5" />,
    },
    {
      title: "Akses Berhasil",
      desc: "Selesai! Praktikum dapat dimulai.",
    ...
    <div className="min-h-screen bg-white font-sans text-slate-900 relative antialiased">
      ...
      <section className="relative flex flex-col items-center justify-center pt-32 pb-20 px-6 text-center bg-gradient-to-br from-[#FFF0F7] via-[#F0F4FF] to-[#F5F8FF] overflow-hidden">
        ...
        >
          ...
          <motion.h1
            variants={itemVariants}
            className="text-4xl md:text-5xl font-bold text-[#263C92] leading-tight mb-5 tracking-tight"
          >
            Monitoring Lab <br />
          ...
          <motion.p
            variants={itemVariants}
            className="text-slate-500 max-w-xl mx-auto text-[15px] md:text-[16px] font-normal leading-relaxed mb-10"
          >
            Pantau penggunaan ruangan praktikum secara otomatis berdasarkan
            jadwal berjalan hari ini untuk mendukung efisiensi kegiatan belajar
            mengajar.
          </motion.p>
        </motion.div>
      ...
      <section className="relative w-full bg-white pt-16 pb-12 border-b border-slate-100">
        <div className="max-w-6xl mx-auto px-6">
          ...
          >
            ...
            <h2 className="text-3xl font-bold text-[#263C92] tracking-tight mb-3">
              Status Laboratorium
            </h2>
            <p className="text-slate-500 text-sm font-medium">
              Kondisi ruangan pada sesi yang sedang berjalan saat ini.
            </p>
          </motion.div>
              ...
              >
                <div>
                  <div className="flex justify-between items-start mb-3 gap-1">
                    ...
                    <div
                      className={`flex items-center gap-1 px-2 py-0.5 rounded-full ${getStatusStyle(lab.status)}`}
                    >
                  ...
                  <h3 className="text-[15px] font-bold text-[#263C92] leading-tight mb-2 group-hover:text-[#E40082] transition-colors">
                    {lab.name}
                  </h3>
          ...
          <div className="flex justify-center">
            <Link
              href="/labvoks/jadwal"
              className="group flex items-center gap-2 text-[#263C92] font-bold text-sm hover:text-[#E40082] transition-colors"
            >
      ...
      <section className="relative w-full py-20 px-6 overflow-hidden bg-[#F8FAFC]">
        ...
        <div className="relative z-10 max-w-7xl mx-auto text-center">
          ...
          >
            ...
            <h2 className="text-3xl font-bold text-[#263C92] tracking-tight mb-4">
              Alur Penggunaan Lab
            </h2>
            <p className="text-slate-500 max-w-2xl mx-auto text-sm font-medium leading-relaxed mb-16">
              Ikuti 4 tahapan berikut untuk mendapatkan akses masuk ke fasilitas
              laboratorium secara otomatis.
            </p>
          </motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 relative z-10 max-w-5xl mx-auto">
              {steps.map((step, index) => {
                ...
                return (
                  ...
                  >
                    <div
                      className={`w-12 h-12 mb-4 flex items-center justify-center rounded-2xl font-bold transition-all duration-500 ${isActive ? "bg-[#E40082] text-white rotate-12 shadow-lg shadow-pink-500/30" : "bg-slate-50 text-slate-400"}`}
                    >
                      {isActive ? step.icon : index + 1}
                    </div>
                    <h3
                      className={`font-bold mb-2 text-[13px] leading-tight tracking-tight ${isActive ? "text-white" : "text-[#263C92]"}`}
                    >
                      {step.title}
                    </h3>
                    <p
                      className={`text-[10px] leading-relaxed font-medium ${isActive ? "text-white/80" : "text-slate-500"}`}
                    >
                      {step.desc}
                    </p>
                  </motion.div>
          ...
          >
            <motion.div className="w-full lg:w-1/2" variants={itemVariants}>
              ...
              <h2 className="text-4xl md:text-5xl font-bold text-[#263C92] mb-8 leading-[1.1] tracking-tight">
                ...
                <span className="text-[#E40082] font-semibold">
                  Layanan LabVoks
                </span>
              </h2>
              <div className="relative p-6 rounded-[32px] bg-amber-50 border border-red-200 flex items-start gap-5 overflow-hidden group shadow-sm">
                ...
                <div className="relative z-10">
                  <h5 className="font-bold text-red-700 mb-1 text-[15px] uppercase tracking-wide">
                    Peringatan Keras
                  </h5>
                  <p className="text-[13px] text-red-800 leading-relaxed font-semibold tracking-tight">
                    Pelanggaran protokol dapat mengakibatkan penangguhan akun
                    secara otomatis oleh sistem keamanan kami.
                  </p>
                </div>
              </div>
            </motion.div>
            ...
            <div className="w-full lg:w-1/2 flex flex-col gap-5">
              {[
                {
                  title: "Window Waktu Presensi",
                  desc: "Scan KTM digital hanya berlaku 15–30 menit sebelum sesi dimulai. Keterlambatan akan membatalkan sesi.",
                ...
                {
                  title: "Komitmen Fasilitas",
                  desc: "Setiap kerusakan sarana akibat kelalaian menjadi tanggung jawab penuh peminjam secara legal.",
                ...
                >
                  <div
                    className={`w-14 h-14 rounded-2xl flex items-center justify-center shrink-0 transition-all duration-300 ${card.bg} text-white group-hover:rotate-6 shadow-lg shadow-black/5`}
                  >
                    {card.icon}
                  </div>
                  <div className="flex-1">
                    ...
                    <p className="text-[13px] text-slate-500 leading-relaxed font-medium group-hover:text-slate-700 transition-colors tracking-tight">
                      {card.desc}
                    </p>
                  </div>
                </motion.div>
